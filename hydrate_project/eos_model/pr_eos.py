...
class PREOS(EquationOfState):
    ...
    def _calc_fugacity_coefficients(self, T, P):
        ...
        for i in range(n):
            term1 = (bi[i] / bm) * (Z - 1)
            term2 = (
                np.log(Z - B) if (Z - B) > 0 else -999.0
